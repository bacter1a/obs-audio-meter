...
export function renderMeter({ name = "OBS Audio Meter", levels = [-Infinity, -Infinity], peaks = [-Infinity, -Infinity], channels = 2, status = "", clip = false }, dial = false) {
